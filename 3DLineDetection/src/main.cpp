...
{
	string fileData = "x_y_z_for_line_segmentation.txt";
	std::cout << "fileData correctly defined!" << std::endl;
	...
	std::cout << "Finished reading data :-)\nFor example some of it is:" << std::endl;
	std::cout << pointData.pts[0].x << std::endl;


	int firstArg = std::atoi(argv[1]);
	int secondArg = std::atoi(argv[2]);
	int thirdArg = std::atoi(argv[3]);
	int fourthArg = std::atoi(argv[4]);
	std::cout << "First argument is: " << firstArg << std::endl;
	std::cout << "Second argument is: " << secondArg << std::endl;
	std::cout << "Third argument is: " << thirdArg << std::endl;
	std::cout << "Fourth argument is: " << fourthArg << std::endl;

	int k = firstArg;
	LineDetection3D detector(secondArg, thirdArg, fourthArg);
